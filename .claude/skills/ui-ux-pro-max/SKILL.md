---
name: ui-ux-pro-max
description: "Project-focused UI/UX design intelligence for this React learning platform. Use when designing, building, reviewing, or fixing pages, components, design systems, accessibility, responsive layouts, typography, color, charts, motion, and React/Three.js UI implementation."
---

# UI/UX Pro Max — Project Edition

Searchable local UI/UX guidance for product patterns, styles, palettes, typography, accessibility, interaction, motion, charts, icons, React performance, and the selected web stacks. Large upstream validation catalogs and stacks unrelated to this product are intentionally omitted.
...
Domain is auto-detected from the query if `--domain` is omitted. If results look off-topic, pass `--domain` explicitly.
...
**Available project stacks:** `react`, `nextjs`, `html-tailwind`, `shadcn`, `threejs`. Use the stack detected in Step 1.
